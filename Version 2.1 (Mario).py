...
carimg = pygame.image.load('Mario\mario_straight.png').convert_alpha()
carrightimg = pygame.image.load('Mario\mario_right_turn.png').convert_alpha()
carleftimg = pygame.image.load('Mario\mario_left_turn.png').convert_alpha()
trackimg = pygame.image.load('Pictures\Track_2.png').convert()
goombaimg= pygame.image.load('Goomba\Vector-goomba.png').convert_alpha()
koopaimg = pygame.image.load('Koopa\Vector-koopa.png').convert_alpha()
bombimg = pygame.image.load('Bomb\Vector-bomb.png').convert_alpha()
